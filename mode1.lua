...
local function showGOTable()
    ...
    gameOverHighScore2 = display.newText( sceneGroup, "7", display.contentCenterX, 690, font, 52 )
...
local function setField()
	...
	schtrafLabel = display.newText( sceneGroup, "-1", 500, 50, font, timerFontSize+4 )
