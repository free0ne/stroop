...
local function setField()
	...
	taskLabel2 = display.newText( sceneGroup, "", display.contentCenterX+3, display.contentHeight*0.177+3, font, taskFontSize )
	taskLabel = display.newText( sceneGroup, "", display.contentCenterX, display.contentHeight*0.177, font, taskFontSize )
    ...
    clrImgTask = display.newImage( sceneGroup, "palette.png", display.contentCenterX-70, display.contentHeight*0.3125 )
    clrImgTask:scale(0.7, 0.7)
    clrImgTask:setFillColor( 0, 1 )
    clrImgTask.isVisible = false
    nameImgTask = display.newImage( sceneGroup, "word.png", display.contentCenterX+70, display.contentHeight*0.3125  )
    nameImgTask:scale(0.7, 0.7)
    nameImgTask:setFillColor( 0, 1 )
    nameImgTask.isVisible = false
    clrImgAnswers = display.newImage( sceneGroup, "palette.png", display.contentCenterX-70, display.contentHeight*0.4167 )
    clrImgAnswers:scale(0.7, 0.7)
    clrImgAnswers:setFillColor( 0, 1 )
    clrImgAnswers.isVisible = false
    nameImgAnswers = display.newImage( sceneGroup, "word.png", display.contentCenterX+70, display.contentHeight*0.4167 )
	...
	for i = 0,3 do
		answersColored[i] = display.newText( sceneGroup, "ответ"..i, display.contentCenterX, display.contentHeight*0.5417 + i*display.contentHeight*0.09375, font, answerSize )
